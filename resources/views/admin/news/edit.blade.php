...
@section('content')
<form class="flex gap-8 p-10" method="POST" enctype="multipart/form-data" action="{{ route('admin.news.update', $post->id) }}">
    @csrf
    ...
    <div class="flex flex-col gap-8 grow">
        ...
        <div class="bg-white shadow-lg rounded-lg flex flex-col gap-4 p-10">
            ...
            <input type="file" name="featured_image" class="hidden" id="image" onchange="onChangeImage(this)">
        </div>
    </div>
</form>
@endsection
